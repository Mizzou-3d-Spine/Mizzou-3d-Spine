...
datamerge <- function(InputPath = NULL, OutputPath = NULL){
  if(is.null(InputPath)){
    InputPath <- choose.dir(caption = "Please Choose the Input Folder")
  }
  if(is.null(OutputPath)){
    OutputPath <- choose.dir(caption = "Please Choose the Output Folder")
  }
  ...
  Data_Dictionary <- data.frame(Table = c(c("Basic Information", " "),
                                ...
                                Explanation = c("Patient ID, pecified by the folder names",
